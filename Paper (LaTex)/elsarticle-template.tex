...
\begin{figure}
    \caption{Daily Wind Speed(Boardwalk) Averaged for 10m}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time,
...
\begin{figure}
    \caption{Daily Wind Speed(Boardwalk) Averaged for 1hr}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time,
            x label style={at={(axis description cs:1.05,0.12)},anchor=north},
...
\begin{figure}
    \caption{Weekly Wind Speed(Boardwalk) Averaged for 30m}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time, 
            x label style={at={(axis description cs:1.05,0.12)},anchor=north},
...
\begin{figure}
    \caption{Weekly Wind Speed(Boardwalk) Averaged for 4hr}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time, 
            x label style={at={(axis description cs:1.05,0.12)},anchor=north},
...
\begin{figure}
    \caption{Monthly Wind Speed(Boardwalk) Averaged for 2hr}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time,
            x label style={at={(axis description cs:1.05,0.12)},anchor=north},
...
\begin{figure}
    \caption{Monthly Wind Speed(Boardwalk) Averaged for 1 day}
    \begin{tikzpicture}
        \begin{axis}[
            xlabel=time, 
            x label style={at={(axis description cs:1.05,0.12)},anchor=north},
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{May 22}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerofourtwotwotenminutes};
            \addlegendentry{April 22}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerothreetwotwotenminutes};
            \addlegendentry{March 22}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{May 15-22}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerofouronefivethirtyminutes};
            \addlegendentry{April 15-22}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerothreeonefivethirtyminutes};
            \addlegendentry{March 15-22}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{April-May}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerothreetwotwozerofourtwotwortwohour};
            \addlegendentry{March-April}
            \addplot+[no markers] table[x=Time,y=Power (kw)] {\windzerotwotwotwozerothreetwotwortwohour};
            \addlegendentry{Feb.-March}
        \end{axis}
    \end{tikzpicture}
