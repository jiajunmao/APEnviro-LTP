...
Boardwalk all satisfy the the Location Determination Factor 1 (powerful and consitent wind) from the survey result and thus qualify for being considered for the Location Determination Factor 2 (feasible location).  %/TODO: Conduct statisitcal test
