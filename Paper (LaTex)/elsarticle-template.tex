...
\pgfplotstableread[col sep=comma]{../Data/1day/windata10m.csv}\windoneday
\pgfplotstableread[col sep=comma]{../Data/1week/windata30m.csv}\windoneweektwohour
\pgfplotstableread[col sep=comma]{../Data/1month/windata2h.csv}\windonemonth
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+[no markers] table[x=Time,y=WS (m/s)] {\windoneday};
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+[no markers] table[x=Time,y=WS (m/s)] {\windoneweek};
    \end{axis}
\end{tikzpicture}
